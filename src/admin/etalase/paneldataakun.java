...
public class paneldataakun extends javax.swing.JPanel {
    ...
    /**
     * Creates new form paneldataakun
     */
    ...
    protected void datatable(){
        Object[] Baris = {"ID User","Nama","Alamat","No HP","Username","Password"};
        tabmode = new DefaultTableModel(null, Baris);
        String cariitem = txtcari.getText();
        try {
            String sql = "SELECT * FROM member where id like '%"+cariitem+"%' or nama like '%"+cariitem+"%' order by id asc";
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtnohp, javax.swing.GroupLayout.PREFERRED_SIZE, 247, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        try {
            ...
            stat.setString(5, txtusernm.getText());
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        String sql = "UPDATE member SET username=?,password=?,nama=?,nohp=?,alamat=? WHERE id='"+txtid.getText()+"'";
        try {
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(5, txtusernm.getText());
            stat.setString(6, txtpass.getText());
